...
#selenium webdriver for Browser Actions
...
from agent.selenium.utils import (
...
class SeleniumWrapper:
    """Wrapper Around Selenium Functionalities"""
    def __init__(self, headless: bool = False)->None:
        "Init Selenium and start interactive session"
        ...
        self.driver.implicitly_wait(5) ## Wait for 5 seconds for all elements to load
